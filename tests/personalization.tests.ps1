...
Assert-True ($personalization -notmatch 'HKCU:\\Software\\Policies' -and $personalization -notmatch 'DisableSearchBoxSuggestions') 'A fase diaria nao deve gravar politicas protegidas nem confundir o historico do Explorador com pesquisa web.'
