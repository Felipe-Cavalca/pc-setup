...
Assert-True ($personalization -match 'StartupBoostEnabled' -and $personalization -match 'BackgroundModeEnabled') 'O Edge nao deve permanecer em segundo plano ou usar inicio rapido.'
