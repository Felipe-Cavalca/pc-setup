...
Assert-True ($machine -match 'Windows Search' -and $machine -match 'DisableWebSearch' -and $machine -match 'ConnectedSearchUseWeb') 'A fase administrativa deve aplicar as politicas de pesquisa web da maquina.'
Assert-True ($personalization -match 'DisableSearchBoxSuggestions' -and $personalization -match 'WebSearchDisabled') 'A fase diaria deve remover sugestoes web do perfil.'
