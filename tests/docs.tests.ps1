...
$requiredDocumentation = @{
    'README.md'                           = @('## TL;DR', 'DEBLOAT.cmd', 'VERIFICAR.cmd', 'TESTAR.cmd', 'ai-memory', 'agente', '--nova', '--sem-memoria', '/mnt/d/Felipe/Dev', '0x80072ee7', 'PLANO-PC-SETUP.html', 'TESTAR-INTEGRACAO.cmd', 'execution-*.jsonl')
