...
Assert-True ($userPhase -match 'Assert-PcSetupCompletedApplyReport' -and $userPhase -match 'Install-AgentCommand\.ps1' -and $userPhase -match '60-packages\.ps1' -and $userPhase -match '80-personalization\.ps1') 'A fase do usuario deve instalar o comando agente, exigir a aplicacao protegida e executar pacotes e personalizacao.'
