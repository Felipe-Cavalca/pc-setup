...
Assert-True ($launcher.Contains('root="$1"') -and $launcher.Contains('compgen -G "$root/$pattern"')) 'O preflight deve consultar somente os globs configurados, preservando quoting do Bash.'
